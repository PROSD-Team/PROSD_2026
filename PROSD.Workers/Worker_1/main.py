...
# Ініціалізація воркер-ноди з конфігурацією через змінні середовища
app = WorkerNode(
...
# JSON-схема вхідних даних для валідації та генерації UI на фронтенді
SCHEMA = {
...
def multiply_array(parameters):
    """
    Бізнес-логіка алгоритму.
    Приймає словник параметрів, повертає результат, який буде записаний в output.json.
    """
